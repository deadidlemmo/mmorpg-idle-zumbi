...
export declare class GatheringService {
    private readonly prisma;
    private readonly activityGuard;
    constructor(prisma: PrismaService, activityGuard: ActivityGuardService);
    private validateGatheringOrigin;
    private getOrCreateGatheringSkill;
    private findActiveGatheringSession;
    private buildSessionPayload;
    private buildProductionPayload;
    private buildProductionPreviewPayload;
    private resolveActiveGathering;
    listAvailableMaterials(params: {
        mapId: string;
        origin: MaterialOrigin;
    }): Promise<{
        map: {
