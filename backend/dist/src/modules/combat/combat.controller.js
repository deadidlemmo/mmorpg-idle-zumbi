...
const start_combat_dto_1 = require("./dto/start-combat.dto");
let CombatController = class CombatController {
    combatService;
    constructor(combatService) {
        this.combatService = combatService;
    }
    start(request, startCombatDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, start_combat_dto_1.StartCombatDto]),
    __metadata("design:returntype", void 0)
], CombatController.prototype, "start", null);
