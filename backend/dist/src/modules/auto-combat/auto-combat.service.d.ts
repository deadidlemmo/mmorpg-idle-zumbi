...
export declare class AutoCombatService implements OnModuleDestroy {
    ...
    private loadAutoCombatSession;
    private processActiveSessionById;
    private spawnNextMobForSession;
    private sessionNeedsMobSpawn;
    private addSeconds;
    private finishActiveSessionAtEnd;
    ...
    private getProcessingResultMessage;
    private resolveRealtimeRound;
    private persistRealtimeRoundResult;
    private claimSessionProcessingStep;
    ...
    private persistRealtimeEventsInTransaction;
